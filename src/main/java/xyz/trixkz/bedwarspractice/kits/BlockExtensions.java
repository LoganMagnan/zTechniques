...
public class BlockExtensions extends Kit {

    @Override
    public String getName() {
        return Utils.translate("&dBlock Extensions");
    }
    ...
    public List<String> getLore() {
        ...
        lore.add(Utils.translate("&9Learn advanced clutches"));
        lore.add(Utils.translate("&9in an isolated environment"));
        lore.add(Utils.translate(""));
    ...
    public UserState getUserState() {
        return UserState.BLOCK_EXTENSIONS;
    }
