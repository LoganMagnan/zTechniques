...
public class SideClutch extends Kit {

    @Override
    public String getName() {
        return Utils.translate("&dSide Clutch");
    }
    ...
    public List<String> getLore() {
        ...
        lore.add(Utils.translate("&9Even more ways to clutch"));
        lore.add(Utils.translate("&9on the side of blocks"));
        lore.add(Utils.translate(""));
